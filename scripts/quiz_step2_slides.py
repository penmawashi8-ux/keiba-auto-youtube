...
def make_question_slide(q: dict, out_path: Path, clue_header: str = "G1 勝利歴",
    ...
    ax.text(0.43, 0.857, "この馬は誰？", ha="center", va="center",
            color=ACCENT, fontsize=88, fontweight="bold")
    ax.plot([0.10, 0.67], [0.832, 0.832], color=ACCENT, linewidth=2.0, alpha=0.5)
    ax.plot([0.67, 0.76], [0.832, 0.832], color=ACCENT2, linewidth=2.0)
    ax.text(0.965, 0.862, f"Q{q['number']}", ha="right", va="center",
            color=ACCENT2, fontsize=20, fontweight="bold")
    ax.text(0.965, 0.843, "/ 5", ha="right", va="center",
