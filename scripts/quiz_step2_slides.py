...
def make_question_slide(q: dict, out_path: Path, clue_header: str = "G1 勝利歴",
    ...
    ax.text(0.43, 0.850, "この馬は誰？", ha="center", va="center",
    ...
    positions = [
        (0.025, 0.322, 0.452),  # A
        (0.522, 0.304, 0.438),  # B: 18px低め・幅狭め
        (0.025, 0.158, 0.448),  # C
        (0.522, 0.140, 0.442),  # D: 18px低め
    ]
    box_h = 0.128
...
def make_answer_slide(q: dict, out_path: Path, part_title: str = "",
    ...
    if use_photo:
        ...
        ax.text(0.270, 0.228, q["display_explanation"], ha="center", va="center",
                color=WHITE, fontsize=26, multialignment="center", zorder=3)
