...
SYSTEM_PROMPT = (
    ...
    "- 記事に書かれている情報を丁寧に伝えること。300文字以上・500文字以内を目安にすること\n"
    "- レース結果・騎手コメント・馬の状態など、記事に書かれた具体的な情報をすべて盛り込むこと\n"
    "- 騎手のコメントが記事にある場合は、そのコメントを引用して伝えること（「○○騎手は『…』と語りました」など）\n"
    "- 情報が少ない記事でも、記事に書かれた内容を丁寧に言い換えて200文字程度にまとめること\n"
